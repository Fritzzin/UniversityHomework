        ...
        <div>
            <table class="table table-striped">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col" style="width: 10%">
                            <a title="Adicionar" href="cliente_inclui.jsp">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td><a title="Excluir" href="cliente_exclui.jsp?id=<%=rs.getString("id")%>"><i class="fa fa-times-circle fa-2x" style="color: red"></i></a>
                            <a title="Editar" href="cliente_altera.jsp?id=<%=rs.getString("id")%>&nome=<%=rs.getString("nome")%>&endereco=<%=rs.getString("endereco")%>"><i class="fa fa-pencil fa-2x" style="color: black"></i></a>
                        </td>
